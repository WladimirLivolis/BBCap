...
```
USAGE: sudo python bbcap.py [-v] -d DESTINATION -f INPUT_FILE -t NUMBER_OF_TRAINS -c NUMBER_OF_CARS --locomotive-size --bigger-car-size --smaller-car-size --caboose-size --max-hops --timeout
```
