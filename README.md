...
2. Envia 2 grupos de trens de pacotes para o destino:
	2.1 Grupo 1:
		2.1.1 Para cada trem de pacotes do grupo 1:
			...
			2.1.1.3 UM pacote (CAUDA)*** é enviado: tamanho = ZERO e TTL = K;
			2.1.1.4 Retorna RTT = tempo entre o envio da locomotiva e a resposta ao envio da cauda;
	...
	2.2 Grupo 2:
		2.2.1 Para cada trio de pacotes do grupo 2:
			...
			2.2.1.3 UM pacote (CAUDA)*** é enviado: tamanho = ZERO e TTL = K;
			2.2.1.4 Retorna RTT = tempo entre o envio da locomotiva e a resposta ao envio da cauda;
...
*   Os pacotes LOCOMOTIVA não geram resposta por possuírem TTL < K ou por serem pacotes malformados.
**  Os pacotes VAGÃO não geram resposta por serem pacotes malformados.
*** Os pacotes CAUDA possuem tamanho igual ao tamanho de seus headers.
```
